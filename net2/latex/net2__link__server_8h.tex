...
\begin{DoxyCompactList}\small\item\em Runs the net2 link server \-: starts listening and accepting incoming connections requests. It has a fancy signature because it will be executed in a different thread and thread format in C is \-: \char`\"{}void$\ast$ ($\ast$) (void$\ast$)\char`\"{}. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
{\em net2\-\_\-link\-\_\-server} & A pointer to copy the address of the link server singleton instance that will be created. \\
\hline
