 ...
 * @return \li SUCCESS : Non negative number that is the socket descriptor
 ...
 * @return \li SUCCESS : Non-negative number that is the accepted socket descriptor
 		   \li FAILED : -1, errno is set approprietaly
 ...
 * @return \li SUCCESS : Non-negative number that is he amount of byte written
           \li FAILED : -1, errno is set approprietaly
 **/
 ...
 * @return \li SUCCESS : Non-negative and non-null number that is the number of read bytes
